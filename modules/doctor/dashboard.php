<div class="bg-white rounded p-4 ">
    <div class="row-fluid">
        <h5 class="text-center mb-4">BẢNG ĐIỂU KHIỂN</h5>
        <div class="card bg-dark text-white" style="max-width: 100%;">
            <img src="/thesixhospital/assets/images/slider.jpg" class="card-img mw-100 " alt=""/>
                ...
                <a href="index.php?page=examination" class="btn btn-primary rounded-2 m-3 px-5">KHÁM BỆNH</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="card rounded-3">
                        <a href="#" class="btn btn-dark">
                            <div class="card-body text-center row">
                                ...
                                <div class="col-3">
                                    <span class="bi bi-chat-dots"> 10</span>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card rounded-3">
                        <a href="#" class="btn btn-dark">
                            <div class="card-body text-center row">
                                <div class="col-3">
                                    <span class="bi bi-person-heart"> 15</span>
                                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card rounded-3">
                        <a href="#" class="btn btn-dark">
                            <div class="card-body text-center row">
                                <div class="col-3">
                                    <span class="bi bi-capsule"> 20</span>
                                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card rounded-3">
                        <a href="#" class="btn btn-dark">
                            <div class="card-body text-center row">
                                <div class="col-3">
                                    <span class="bi bi-calendar-plus"> 05</span>
                                </div>
